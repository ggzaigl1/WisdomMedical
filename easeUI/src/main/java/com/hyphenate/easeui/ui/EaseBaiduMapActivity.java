...
public class EaseBaiduMapActivity extends AppCompatActivity {
	...
	public class BaiduSDKReceiver extends BroadcastReceiver {
		public void onReceive(Context context, Intent intent) {
			...
			if (s.equals(SDKInitializer.SDK_BROADTCAST_ACTION_STRING_PERMISSION_CHECK_ERROR)) {
				T.showShort(R.string.please_check);
			} else if (s.equals(SDKInitializer.SDK_BROADCAST_ACTION_STRING_NETWORK_ERROR)) {
				T.showShort(R.string.Network_error);
			}
		}
	}
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (latitude == 0) {
			...
			double longtitude = bundle.getDouble("longitude", 0);
	...
	public void sendLocation(View view) {
		...
		bundle.putString("address", lastLocation.getAddrStr());
