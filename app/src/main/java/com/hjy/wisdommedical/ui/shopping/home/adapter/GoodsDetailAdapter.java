 ...
 * @date 2018/10/16
 */
public class GoodsDetailAdapter extends BaseQuickAdapter<ProductInfoBean.ListEvaluationBean, BaseViewHolder> {

    public GoodsDetailAdapter(@Nullable List<ProductInfoBean.ListEvaluationBean> data) {
        super(R.layout.item_assess, data);
    }

    @Override
    protected void convert(BaseViewHolder helper, ProductInfoBean.ListEvaluationBean item) {
