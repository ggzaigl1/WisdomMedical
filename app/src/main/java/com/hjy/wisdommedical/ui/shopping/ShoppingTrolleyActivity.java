...
import com.hjy.wisdommedical.ui.shopping.trolley.ShoppingTrolleyAdapter;
...
public class ShoppingTrolleyActivity extends BaseActivity {
    ...
    private void initRv() {
        mAdapter = new ShoppingTrolleyAdapter(mContext, new ArrayList<>());
        ...
        View headerView = LayoutInflater.from(mContext).inflate(R.layout.trolley_recycle_header, (ViewGroup) mShoppingTrolleyList.getParent(), false);
        mAdapter.addHeaderView(headerView);
        mShoppingTrolleyList.setLayoutManager(new LinearLayoutManager(mContext));
