...
import com.hjy.wisdommedical.ui.inquiry.adapter.VideoAdvisoryAdapter;
 ...
 * 视频咨询
 */
public class VideoAdvisoryActivity extends BaseActivity {
    ...
    private VideoAdvisoryAdapter mAdapter;
    ...
    protected void initData(Bundle savedInstanceState) {
        tv_title.setText(R.string.buy_video_advisory);
    ...
    private void init() {
        ...
        mAdapter = new VideoAdvisoryAdapter(new ArrayList<>());
    ...
    private void initImageRecycler() {
        ...
        imageAdapter = new ImagePickerAdapter(VideoAdvisoryActivity.this, selImageList, maxImgCount);
        ...
        imageAdapter.setItemClickListener(new ImagePickerAdapter.OnItemClickListener() {
            ...
            public void onItemClick(int position) {
                if (position == imageAdapter.getImages().size()) {
                    ...
                    Intent intentPreview = new Intent(VideoAdvisoryActivity.this, ImagePreviewDelActivity.class);
                    ...
                    public void convertView(ViewHolder holder, final BaseNiceDialog dialog) {
                        ...
                        holder.setOnClickListener(R.id.bt_photo, new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent intent = new Intent(VideoAdvisoryActivity.this, ImageGridActivity.class);
                        ...
                        holder.setOnClickListener(R.id.bt_album, new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                //打开选择,本次允许选择的数量
                                ImagePicker.getInstance().setSelectLimit(maxImgCount - selImageList.size());
                                Intent intent1 = new Intent(VideoAdvisoryActivity.this, ImageGridActivity.class);
    ...
    private void uploadImages(String type, List<ImageItem> lists) {
        mKProgressHUD = KProgressHUD.create(VideoAdvisoryActivity.this)
        ...
        observable.subscribe(new Consumer<String>() {
            ...
            public void accept(String objectBaseBean) throws Exception {
                if (objectBaseBean != null) {
                    T.showShort(VideoAdvisoryActivity.this.getString(R.string.complete));
