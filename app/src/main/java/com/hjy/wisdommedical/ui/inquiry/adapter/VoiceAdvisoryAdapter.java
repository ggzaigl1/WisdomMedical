 ...
 *
 */
public class VoiceAdvisoryAdapter extends  BaseQuickAdapter<DiseaseBean.ListCommonDiseaseBean, BaseViewHolder> {

    public VoiceAdvisoryAdapter(@Nullable List<DiseaseBean.ListCommonDiseaseBean> data) {
