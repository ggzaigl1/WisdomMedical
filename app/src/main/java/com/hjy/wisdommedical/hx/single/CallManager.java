package com.hjy.wisdommedical.hx.single;
...
public class CallManager {
    ...
    private CallState callState = CallState.CONNECTED;
    ...
    public void saveCallMessage() {
        Log.d("callManager", "The call ends and the call log message is saved! " + endType);
        ...
        case NORMAL: // 正常结束通话
            ...
            break;
        case CANCEL: // 取消
            content = context.getString(com.hjy.chat.R.string.call_cancel);
            break;
        case CANCELLED: // 被取消
            content = context.getString(com.hjy.chat.R.string.call_cancel_is_incoming);
            break;
        case BUSY: // 对方忙碌
            content = context.getString(com.hjy.chat.R.string.call_busy);
            break;
        case OFFLINE: // 对方不在线
            content = context.getString(com.hjy.chat.R.string.call_offline);
            break;
        case REJECT: // 拒绝的
            content = context.getString(com.hjy.chat.R.string.call_reject_is_incoming);
            break;
        case REJECTED: // 被拒绝的
            content = context.getString(com.hjy.chat.R.string.call_reject);
            break;
        case NORESPONSE: // 未响应
            content = context.getString(com.hjy.chat.R.string.call_no_response);
            break;
        case TRANSPORT: // 建立连接失败
            content = context.getString(com.hjy.chat.R.string.call_connection_fail);
            break;
    ...
    public void endCall() {
        try {
            Log.i("callManager", "endCall");
            // 调用 SDK 的结束通话方法
            EMClient.getInstance().callManager().endCall();
        } catch (EMNoActiveCallException e) {
            e.printStackTrace();
            Log.e("callManager", e.getMessage());
        }
        // 挂断电话调用保存消息方法
        saveCallMessage();
        // 通话结束，重置通话状态
        ...
        if (bluetoothAdapter != null) {
            bluetoothAdapter.getProfileProxy(context, new BluetoothProfile.ServiceListener() {
                ...
                public void onServiceConnected(int profile, BluetoothProfile proxy) {
                    ...
                    Log.d("callManager", "bluetooth is ");
                }
    ...
    private void loadSound() {
        if (isInComingCall) {
            loadId = soundPool.load(context, com.hjy.chat.R.raw.sound_call_incoming, 1);
        } else {
            loadId = soundPool.load(context, com.hjy.chat.R.raw.sound_calling, 1);
        }
    }
        ...
        if (isLoaded) {
            ...
            soundPool.setOnLoadCompleteListener(new SoundPool.OnLoadCompleteListener() {
                ...
                public void onLoadComplete(SoundPool soundPool, int i, int i1) {
                    Log.d("callManager", "SoundPool load complete! loadId: %d" + loadId);
                    isLoaded = true;
                    // 首次监听到加载完毕，开始播放音频
                    playCallSound();
                }
    ...
    private void addCallNotification() {
        ...
        builder.setSmallIcon(com.hjy.chat.R.mipmap.ic_launcher);
        ...
        builder.setContentTitle(context.getString(com.hjy.chat.R.string.app_name));
