...
public class EaseChatFragment extends BaseFragment implements EMMessageListener {
    ...
    static final int ITEM_VOICE = 4;//语音聊天
    static final int ITEM_VIDEO = 5;//视频聊天
...
//    protected int[] itemdrawables = {R.drawable.ease_chat_takepic_selector, R.drawable.ease_chat_image_selector, R.drawable.ease_chat_location_selector, R.drawable.ease_chat_location_selector, R.drawable.ease_chat_location_selector};
...
//    protected int[] itemIds = {ITEM_TAKE_PICTURE, ITEM_PICTURE, ITEM_LOCATION, ITEM_VOICE, ITEM_VIDEO};
    ...
    protected void initData() {
        ...
        EaseUserUtils.chatType = chatType;
        EaseUserUtils.toChatId = toChatUsername;
...
//                            body.deliverOnlineOnly(true);
                    ...
                    case MSG_TYPING_END:
                        ...
                        // Only deliver this cmd msg to online users
//                        body.deliverOnlineOnly(true); todo
                        endMsg.addBody(body);
...
//        });
    ...
    private void loadMoreLocalMessage() {
        if (listView.getFirstVisiblePosition() == 0 && !isloading && haveMoreData) {
            ...
            T.showShort(R.string.no_more_messages);
        }
        swipeRefreshLayout.setRefreshing(false);
    }
        ...
        if (resultCode == Activity.RESULT_OK ) {//&& null != data
            if (requestCode == REQUEST_CODE_CAMERA) { // capture new image
                ...
                if (locationAddress != null && !locationAddress.equals("")) {
                    ...
                    T.showLong(R.string.unable_to_get_loaction);
                }
        ...
        public void onClick(int itemId, View view) {
            ...
            switch (itemId) {
                ...
                case ITEM_PICTURE:
                    ...
                    break;
                case ITEM_LOCATION:
                    JumpUtils.jump(EaseChatFragment.this, null, EaseBaiduMapActivity.class, REQUEST_CODE_MAP);
                    break;
                case ITEM_VOICE:
    ...
    protected void sendMessage(EMMessage message) {
        ...
        message.setMessageStatusCallback(messageStatusCallback);
        //todo 发送扩展消息 头像未发送
        String imgUrl = ApiService.BASE_PIC_URL + SpfUtils.getSpfSaveStr(Constant.userHeadImg);
        message.setAttribute("hxChartHeadImg", "http://pic30.nipic.com/20130605/7447430_151725918000_2.jpg");
        message.setAttribute("userName", toChatUsername);
    ...
    protected void sendPicByUri(Uri selectedImage) {
        ...
        if (cursor != null) {
            ...
            if (picturePath == null || picturePath.equals("null")) {
                T.showShort(R.string.cant_find_pictures);
                return;
            }
    ...
    protected void toGroupDetails() {
        if (chatType == EaseConstant.CHATTYPE_GROUP) {
            EMGroup group = EMClient.getInstance().groupManager().getGroup(toChatUsername);
            if (group == null) {
                T.showShort(R.string.gorup_not_found);
                return;
            }
            if (chatFragmentHelper != null) {
    ...
    class GroupListener extends EaseGroupListener {
            ...
            getActivity().runOnUiThread(new Runnable() {
                ...
                public void run() {
                    if (toChatUsername.equals(groupId)) {
                        T.showShort(R.string.you_are_group);
                        Activity activity = getActivity();
        ...
        public void onGroupDestroyed(final String groupId, String groupName) {
            ...
            getActivity().runOnUiThread(new Runnable() {
                public void run() {
                    if (toChatUsername.equals(groupId)) {
                        T.showShort(R.string.the_current_group_destroyed);
                        Activity activity = getActivity();
                        if (activity != null && !activity.isFinishing()) {
                            activity.finish();
                        }
