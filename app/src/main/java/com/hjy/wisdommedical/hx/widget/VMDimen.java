...
public class VMDimen {
    ...
    public static int getStatusBarHeight() {
        ...
        Log.i("dimen", "statusBar.h." + height);
    ...
    public static int getSystemBarHeight() {
        ...
        height = res.getDimensionPixelSize(height);
        Log.i("dimen", "systembar.h." + height);
    ...
    public static int getToolbarHeight() {
        ...
        if ( BaseApplication.getAppContext()
            .getTheme()
            .resolveAttribute(android.R.attr.actionBarSize, tv, true)) {
            height = TypedValue.complexToDimensionPixelSize(tv.data,  BaseApplication.getAppContext()
                .getResources()
                .getDisplayMetrics());
        }
        Log.i("dimen", "toolbar.h." + height);
        return height;
    }
    ...
    private static boolean hasNavigationBar() {
        ...
        Resources rs =  BaseApplication.getAppContext().getResources();
